...
var _default = () => {
  ...
  infScroll.on('append', (response, path, items) => {
    ...
    (0, _highlightPrismjs.default)(newArticle, 'pre[class*=language-] code');
